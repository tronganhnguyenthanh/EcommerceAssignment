...
## npm i 
This command used for install node_modules
...
Step 3: If you see a text show a specific results, it means that the keyword is found. If the list is shown by an 404 image, it means that no item found.
